...
def r_netCDF(f_path, var_name = 'scpdsi', min_lon = -145, min_lat = 14, max_lon = -52, max_lat = 71, swap = 0, force0toNan = False):
    '''
    ...
    if swap == 0:
      mean_df = mean_df[['year', coor[1], coor[0], var_name]]
    ...
    return df_data, ds_n, ret_lon, ret_lat, coor #mean_df, ds_n, ret_lon, ret_lat, coor
